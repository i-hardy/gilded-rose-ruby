...
describe AgedBrie do
  ...
  describe "#update_quality" do
    it "increases the quality by 1 if the sell_in is greater than 0" do
      expect { aged_brie.update_quality }
        .to change { aged_brie.quality }
    ...
    it "increases the quality by 2 if the sell_in is less than 0" do
      ...
      expect { super_aged_brie.update_quality }
        .to change { super_aged_brie.quality }
    ...
    it "cannot increase the quality beyond 50" do
      ...
      expect { high_quality_brie.update_quality }
        .not_to change { high_quality_brie.quality }
    end
  end
